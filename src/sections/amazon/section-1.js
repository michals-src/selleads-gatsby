                ...
                <div className="my-32 flex flex-row flex-nowrap items-center">
                    ...
                    <div className="w-8/12 flex flex-col justify-center pl-10 md:pl-16 lg:pl-32">
                        ...
                        <div className="flex flex-col mt-10">
                            <div className=" flex flex-row flex-nowrap px-16 py-9 border-b border-pastelGreen-150">
                                <h3 className="text-3xl text-pastelGreen-200 font-bold mr-8">1</h3>
                                <div>
                                    <h1 className="text-4xl font-bold mb-5">Masz pomysł</h1>    
                                    <h1 className="text-2xl">Na genialny produkt, a nie wiesz jak zacząć?</h1>    
                                </div>
                            </div>
                            <div className=" flex flex-row flex-nowrap px-16 py-9 border-b border-pastelGreen-150">
                                <h3 className="text-3xl text-pastelGreen-200 font-bold mr-8">2</h3>
                                <div>
                                    <h1 className="text-4xl font-bold mb-5">Sprzedajesz</h1>    
                                    <h1 className="text-2xl">I myślisz, aby otworzyć dodatkowy kanał sprzedaży?</h1>    
                                </div>
                            </div>
                            <div className=" flex flex-row flex-nowrap px-16 py-9 ">
                                <h3 className="text-3xl text-pastelGreen-200 font-bold mr-8">3</h3>
                                <div>
                                    <h1 className="text-4xl font-bold mb-5">A może</h1>    
                                    <h1 className="text-2xl">Już działasz na Amazonie?</h1>    
                                </div>  
                            </div>
                        </div>
            ...
            <div className="container mx-auto px-4 md:px-14">
                <div className="flex flex-col">
                    <div className="max-w-4xl my-24">
                        <h6 className="text-xl text-pastelGreen-400 mb-6">Płyń z wiatrem w żaglach.</h6>  
                    ...
                    <div className="w-full flex flex-row flex-wrap align-center pr-32 -mx-6">
                        <div className="w-6/12 flex flex-row flex-nowrap items-center py-5 px-6">
                            <span className="mr-10 text-pastelGreen-500">
