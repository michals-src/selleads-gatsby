...
const ListBlockItem = styled.div`
    ...
    align-items: center;
    border-bottom: 1px solid #b9bdb03d;
...
const Icon = (props) => {
    ...
    return <IconWrapper>{icons[props.name]()}</IconWrapper>;
    ...
    return (
        ...
        <div className="_container">
            <Wrapper>
                ...
                <ListBlockWrapper>
                    <ListBlockItem><Icon name="boardChart" />Analiza potencjału produktu</ListBlockItem>
                    <ListBlockItem><Icon name="infoCircle" />Pomoc w znalezieniu producenta produktu oraz sprowadzenie towaru</ListBlockItem>
                    <ListBlockItem><Icon name="personPlus" />Założenie konta i jego weryfikację</ListBlockItem>
                    <ListBlockItem><Icon name="filePlus" /><p>Wystawianie ofert <label>Zrobienie zdjęć i opisu</label></p></ListBlockItem>
