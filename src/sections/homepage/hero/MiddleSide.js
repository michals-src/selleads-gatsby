        ...
        <>
            <div>
                <motion.div
                  ...
                  animate={{ x: "0", opacity: 1, transition: { delay: 0.7, duration: 0.5, ease: [0, -0.55, 0.45, 1]}}}
                  className="w-full relative z-10"
                >
                  <div className="relative z-10 py-24 px-10 rounded-2xl">
                    <div className="rounded-2xl overflow-hidden relative">
                      <img src={undraw_visual_data_re_mxxo} alt="Unsplash - Blake_Wisz_Pic" />
                      </div>
