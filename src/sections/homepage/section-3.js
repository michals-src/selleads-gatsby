...
function Section_3() {
  ...
  `);
    ...
    return (
        <>
            <div className="my-32 text-white bg-pastelGreen">
                <div className="flex flex-row flex-wrap items-center py-16">
                    ...
                    <div className="max-w-3xl ml-auto pl-4 sm:pl-6 lg:pl-6 2xl:pl-14">
                        ...
                        <h3 className="text-3xl mt-4 mb-10">Zanurkuj z nami po sukces.</h3>
                        <Hyper_Button to="/amazon" />
                        </div>
                    </div>
                    </div>
                    <div className="w-6/12 ml-auto overflow-hidden">
                    <Img className="w-full h-screen" fluid={ data["mediensturmer_aWf7mjwwJJo_unsplash"].childImageSharp.fluid } />
                    </div>
                </div>

                <div>
                    <div className="container mx-auto pl-4 sm:pl-6 lg:pl-6 2xl:pl-14" style={{ borderTop: "1px solid #484f48" }}>
                        <div className="py-32">
                            <div className="h-full flex flex-row flex-wrap justify-center">
                            <div className="w-full lg:w-6/12">
                                <h2 className="text-5xl font-bold">Oferta Copywriting.</h2>
                                <h3 className="text-3xl mt-4 mb-10">Wyróżnij produkty, które sprzedajesz.</h3>
                            </div>
                            <div className="w-full lg:w-6/12">
