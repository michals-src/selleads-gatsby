          ...
          <div className="w-full md:w-6/12 md:-ml-0">
            <div className="h-full p-4 h-full">
              <div className="flex flex-col justify-center h-full p-14 bg-green-100 rounded-md">
                <div className="px-4 md:pl-16 text-center">
                  ...
                  <p className="text-lg text-black">Amazon otworzył rynki w 6 europejskich krajach Niemczech, Wielkiej Brytanii, Francji, Włoszech, Hiszpanii oraz Holandii. Dzięki takiej infrastrukturze, sprzedając na platformie jesteśmy w stanie dotrzeć, aż do 28 krajów leżących w Europie.</p>
                </div>
              </div>
            </div>
          </div>
