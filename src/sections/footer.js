                        ...
                        <div className="flex flex-row flex-wrap">
                            <div className="w-6/12">
                                <h1 className="text-6xl leading-tight font-bold">
                                    Jesteśmy dostępni przez
                                    <span className="underline pr-2 inline-flex hover:no-underline"><Link to="/contact">formularz</Link></span>
                                    lub nasz adres.
                                </h1>
                                <p className="text-2xl py-10 text-gray-500">selleads.office@gmail.com</p>
                            </div>
                            <div className="w-6/12 flex flex-col flex-nowrap items-end justify-between py-8">
                                ...
                                <ul className="mt-8 text-right text-2xl">
                                    ...
                                    <li className="my-4"><Link to="#">Polityka prywatności</Link></li>
