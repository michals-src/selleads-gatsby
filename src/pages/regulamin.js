  ...
  return (
    <div>
      ...
      <Navbar />
        ...
        <div className="container pt6 pb3">
            

            <h3 className="_mb3 text-center">Polityka Cookies</h3>
                <p className="mb3" >Poniższa Polityka Cookies określa zasady zapisywania i uzyskiwania dostępu do danych na Urządzeniach Użytkowników korzystających z Serwisu do celów świadczenia usług drogą elektroniczną przez Administratora Serwisu.</p>

            <h5 className="_mb3">§ 1 Definicje</h5>
                <DecimalList className="mb3">
                    <li><p><strong>Serwis</strong> - serwis internetowy działający pod adresem <span id="serwis"><span >www.selleads.pl</span></span></p></li>
            ...
            <h5 className="_mb3">§ 2 Rodzaje Cookies</h5>
                <DecimalList className="mb3">
            ...
            <h5 className="_mb3">§ 3 Bezpieczeństwo</h5>
                <DecimalList className="mb3">
            ...
            <h5 className="_mb3">§ 4 Cele do których wykorzystywane są pliki Cookie</h5>
                <DecimalList id="cele" className="mb3">
                    <li>
            ...
            <h5 className="_mb3">§ 5 Serwisy zewnętrzne</h5>
                <p id="zewinfo"><span >Administrator współpracuje z następującymi serwisami zewnętrznymi, które mogą zamieszczać pliki Cookie na Urządzeniach Użytkownika:</span></p>
                <DecimalList id="zewnetrzne" className="mb3">
                    <li>
            ...
            <h5 className="_mb3" >§ 6 Możliwości określania warunków przechowywania i uzyskiwania dostępu na Urządzeniach Użytkownika przez Serwis<span id="sz6" > i Serwisy zewnętrzne</span></h5>
                <DecimalList className="mb3">
            ...
            <h5 className="_mb3">§ 7 Wyłączenie odpowiedzialności</h5>
                <DecimalList className="mb3">
            ...
            <h5 className="_mb3">§ 8 Wymagania Serwisu</h5>
                <DecimalList className="mb3">
            ...
            <h5 className="_mb3">§ 9 Zmiany w Polityce Cookie</h5>
                <DecimalList className="mb3">
